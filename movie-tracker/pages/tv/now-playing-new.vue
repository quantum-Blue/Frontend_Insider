  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <nav class="mb-6">
      <ol class="flex items-center space-x-2 text-sm text-gray-500">
        ...
        <li>/</li>
        <li class="text-gray-900 font-medium">Airing Today</li>
      </ol>
    </nav>

    <!-- Page Header -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900">TV Shows Airing Today</h1>
      <p class="text-gray-600 mt-2">
        TV shows that are broadcasting today
      </p>
    </div>
