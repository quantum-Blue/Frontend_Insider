...
const category = "tv-airing-today";
const _sfc_main = {
  __name: "now-playing-new",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "TV Shows Airing Today - Movie Tracker",
      ogTitle: "TV Shows Airing Today - Movie Tracker",
      description: "Discover TV shows airing today. Find out what's broadcasting right now.",
      ogDescription: "Discover TV shows airing today. Find out what's broadcasting right now."
    });
    ...
    const fetchTvShows = async (page = 1, append = false) => {
      ...
      try {
        ...
        const endpoint = hasActiveFilters.value ? "/discover/tv" : "/tv/airing_today";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Airing Today</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">TV Shows Airing Today</h1><p class="text-gray-600 mt-2"> TV shows that are broadcasting today </p></div><div class="flex gap-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tv/now-playing-new.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=now-playing-new-CGHzahBz.mjs.map
