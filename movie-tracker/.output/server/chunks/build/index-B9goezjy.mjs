...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" }, _attrs))}><div class="text-center mb-12"><h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4"> Movies </h1><p class="text-lg text-gray-600 max-w-3xl mx-auto"> Discover the latest movies, trending films, and timeless classics. Find your next favorite movie to watch. </p></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("p", { class: "text-blue-100 text-sm" }, "Most popular movies right now"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("p", { class: "text-green-100 text-sm" }, "Movies currently in theaters"),
              createVNode("div", { class: "mt-4 flex items-center text-sm" }, [
                createVNode("span", null, "Explore"),
                (openBlock(), createBlock("svg", {
                  class: "w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("p", { class: "text-purple-100 text-sm" }, "Movies coming to theaters soon"),
              createVNode("div", { class: "mt-4 flex items-center text-sm" }, [
                createVNode("span", null, "Explore"),
                (openBlock(), createBlock("svg", {
                  class: "w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("p", { class: "text-orange-100 text-sm" }, "Highest rated movies of all time"),
              createVNode("div", { class: "mt-4 flex items-center text-sm" }, [
                createVNode("span", null, "Explore"),
                (openBlock(), createBlock("svg", {
                  class: "w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform",
      ...
      _push(`</div><div class="bg-gray-50 rounded-2xl p-8"><div class="flex items-center justify-between mb-8"><div><h2 class="text-2xl font-bold text-gray-900 mb-2">Featured Movies</h2><p class="text-gray-600">Check out some popular movies</p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/movies/popular",
      ...
      if (loading.value) {
        ...
        _push(`<!--]--></div>`);
      } else if (featuredMovies.value.length > 0) {
        _push(`<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6"><!--[-->`);
        ssrRenderList(featuredMovies.value.slice(0, 6), (movie) => {
...
//# sourceMappingURL=index-B9goezjy.mjs.map
