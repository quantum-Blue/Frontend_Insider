...
const category = "tv-upcoming";
const _sfc_main = {
  __name: "upcoming",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "On The Air TV Shows - Movie Tracker",
      ogTitle: "On The Air TV Shows - Movie Tracker",
      description: "Discover TV shows currently on the air. Find shows broadcasting this week.",
      ogDescription: "Discover TV shows currently on the air. Find shows broadcasting this week."
    });
    ...
    const fetchTvShows = async (page = 1, append = false) => {
      ...
      try {
        ...
        const endpoint = hasActiveFilters.value ? "/discover/tv" : "/tv/on_the_air";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Upcoming</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">Upcoming TV Shows</h1><p class="text-gray-600 mt-2"> TV shows currently on the air with episodes broadcasting this week </p></div><div class="flex gap-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tv/upcoming.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=upcoming-BnQ3Cpus.mjs.map
