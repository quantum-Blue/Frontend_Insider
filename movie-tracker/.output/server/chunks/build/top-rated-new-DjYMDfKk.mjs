...
const category = "tv-top-rated";
const _sfc_main = {
  __name: "top-rated-new",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Top Rated TV Shows - Movie Tracker",
      ogTitle: "Top Rated TV Shows - Movie Tracker",
      description: "Discover the highest-rated TV shows. Find critically acclaimed and fan-favorite series.",
      ogDescription: "Discover the highest-rated TV shows. Find critically acclaimed and fan-favorite series."
    });
    ...
    const fetchTvShows = async (page = 1, append = false) => {
      ...
      try {
        ...
        const endpoint = hasActiveFilters.value ? "/discover/tv" : "/tv/top_rated";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Top Rated</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">Top Rated TV Shows</h1><p class="text-gray-600 mt-2"> Highest-rated TV shows based on user ratings </p></div><div class="flex gap-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tv/top-rated-new.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=top-rated-new-DjYMDfKk.mjs.map
