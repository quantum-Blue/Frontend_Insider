...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Now Playing</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">Now Playing Movies</h1><p class="text-gray-600 mt-2"> Movies currently playing in theaters </p></div><div class="flex gap-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/movies/now-playing.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=now-playing-BTwflcRZ.mjs.map
