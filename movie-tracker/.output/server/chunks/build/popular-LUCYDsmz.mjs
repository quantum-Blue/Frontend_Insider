...
const category = "movies-popular";
const _sfc_main = {
  __name: "popular",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Popular Movies - Movie Tracker",
      ogTitle: "Popular Movies - Movie Tracker",
      description: "Discover the most popular movies right now. Browse trending titles and find your next favorite film.",
      ogDescription: "Discover the most popular movies right now. Browse trending titles and find your next favorite film."
    });
    ...
    const fetchMovies = async (page = 1, append = false) => {
      ...
      try {
        ...
        const endpoint = hasActiveFilters.value ? "/discover/movie" : "/movie/popular";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Popular</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">Popular Movies</h1><p class="text-gray-600 mt-2"> Discover the most popular movies right now </p></div><div class="flex gap-8">`);
      ...
      if (loading.value && movies.value.length === 0) {
        ...
        _push(`<div class="text-center py-12"><svg class="mx-auto h-12 w-12 text-red-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"></path></svg><h3 class="text-lg font-medium text-gray-900 mb-2">Error Loading Movies</h3><p class="text-gray-500 mb-4">${ssrInterpolate(error.value)}</p><button class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"> Try Again </button></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/movies/popular.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=popular-LUCYDsmz.mjs.map
