...
const category = "movies-top-rated";
const _sfc_main = {
  __name: "top-rated",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Top Rated Movies - Movie Tracker",
      ogTitle: "Top Rated Movies - Movie Tracker",
      description: "Discover the highest-rated movies. Find critically acclaimed and fan-favorite films.",
      ogDescription: "Discover the highest-rated movies. Find critically acclaimed and fan-favorite films."
    });
    ...
    const fetchMovies = async (page = 1, append = false) => {
      ...
      try {
        ...
        const endpoint = hasActiveFilters.value ? "/discover/movie" : "/movie/top_rated";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li>/</li><li class="text-gray-900 font-medium">Top Rated</li></ol></nav><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900">Top Rated Movies</h1><p class="text-gray-600 mt-2"> Highest-rated movies based on user ratings </p></div><div class="flex gap-8">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/movies/top-rated.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=top-rated-BuuIAAEJ.mjs.map
