...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" }, _attrs))}><div class="text-center mb-8"><h1 class="text-4xl font-bold text-gray-900 mb-4">TV Shows</h1><p class="text-lg text-gray-600 max-w-2xl mx-auto"> Explore the world of television with our curated collection of shows. From trending series to top-rated classics. </p></div><div class="flex justify-center mb-8"><div class="bg-white rounded-lg shadow-sm border p-1"><!--[-->`);
      ...
      _push(`<!--]--></div></div>`);
      if (_ctx.$route.path === "/tv") {
        _push(`<div>`);
        if (unref(loading)) {
          _push(`<div class="text-center py-12"><div class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div><p class="mt-4 text-gray-600">Loading TV shows...</p></div>`);
        } else if (unref(error)) {
          _push(`<div class="text-center py-12"><svg class="mx-auto h-12 w-12 text-red-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><h3 class="text-lg font-medium text-gray-900 mb-2">Error loading TV shows</h3><p class="text-gray-500 mb-4">${ssrInterpolate(unref(error))}</p><button class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"> Try Again </button></div>`);
        } else {
          _push(`<div class="space-y-8"><div class="flex items-center justify-between"><h2 class="text-2xl font-bold text-gray-900">Popular TV Shows</h2>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/tv/popular",
          ...
          ssrRenderList(unref(tvShows).slice(0, 18), (show) => {
          ...
          _push(`<!--]--></div><div class="text-center text-sm text-gray-500"> Showing ${ssrInterpolate(Math.min(18, unref(tvShows).length))} of ${ssrInterpolate(unref(totalResults))} TV shows </div></div>`);
        }
        _push(`</div>`);
      } else {
        _push(`<div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tv.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tv-DiQ5btcP.mjs.map
